...
function setBackgroundColour(e) {
...
function createGridSquares () {
    const noOfSquares = (squaresPerSide*squaresPerSide);
    ...
    for (let i = 0; i<noOfSquares; i++) {
        ...
        gridCell.addEventListener("mousedown", (e) => setBackgroundColour(e))
        gridCell.addEventListener("mouseover", (e) => setBackgroundColour(e))
        gridCell.addEventListener("mouseup", (e) => setBackgroundColour(e))
